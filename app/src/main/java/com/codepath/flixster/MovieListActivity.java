...
public class MovieListActivity extends AppCompatActivity {
    ...
    // constants; the base URL for the API
    ...
    private void getNowPlaying() {
        ...
        params.put(API_KEY_PARAM, getString(R.string.api_key)); // API key, always needed
        // execute GET request for JSON object response
